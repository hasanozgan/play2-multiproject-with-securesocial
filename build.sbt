...
//
// WARNING: This file requires page blank line between each entry (excluding comments); this is because scala does not use ";" so blank line is how sbt understands next command
//
...
// sbt and Play Framework support the concept of sub-projects. Each subproject represents page major module in our project.
